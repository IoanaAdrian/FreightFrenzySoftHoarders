...
public class HardwareDeclarations {
    ...
    public static PIDFCoefficients sliderVelocityPID = new PIDFCoefficients(1, 2, 3, 4);
    public static PIDFCoefficients sliderPositionPID = new PIDFCoefficients(1, 2, 3, 4);
